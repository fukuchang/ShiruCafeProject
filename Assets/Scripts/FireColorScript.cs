...
public class FireColorScript : MonoBehaviour {
	...
	void Awake () {
        ...
        m_preColor = m_color;
        childFire = gameObject.transform.Find("Sphere").gameObject;
        m_sphereCollider = childFire.GetComponent<SphereCollider>();
        ps = gameObject.transform.Find("fire").GetComponent<ParticleSystem>();
